...
public class ListViewAdapter2 extends BaseAdapter {
    ...
    private final List<MineralesAdapter2.Minerales> items;
    public ListViewAdapter2(Context context, List<MineralesAdapter2.Minerales> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MineralesAdapter2.Minerales item = this.items.get(position);
