...
public class CreditsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (theme.equals("darck")) {
            ...
            textAuthors.setTextColor(getResources().getColor(R.color.black));
            ...
            textMariajose4.setTextColor(getResources().getColor(R.color.blue_contrast));
            textPictures.setTextColor(getResources().getColor(R.color.black));
            ...
            textTranslations.setTextColor(getResources().getColor(R.color.black));
            textArabian.setTextColor(getResources().getColor(R.color.black));
            textRussian.setTextColor(getResources().getColor(R.color.black));
            textCatalan.setTextColor(getResources().getColor(R.color.black));
        ...
        textManuel5.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://earthscience.stackexchange.com/users/28185/universal-learner"));
            startActivity(browserIntent);
        });
        textManuel6.setOnClickListener(v -> {
