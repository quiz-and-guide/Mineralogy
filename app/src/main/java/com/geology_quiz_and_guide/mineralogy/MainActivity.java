...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_guide, R.id.nav_quiz, R.id.nav_settings, R.id.nav_store, R.id.nav_moreapps, R.id.nav_credits)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.item_share) {
            ...
            sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "Mineralogy: Quiz and Guide. Download free https://play.google.com/store/apps/details?id=com.geology_quiz_and_guide.mineralogy");
            startActivity(Intent.createChooser(sharingIntent,"Share using"));
        } else if (item.getItemId() == R.id.facebook) {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/profile.php?id=100084432273132"));
