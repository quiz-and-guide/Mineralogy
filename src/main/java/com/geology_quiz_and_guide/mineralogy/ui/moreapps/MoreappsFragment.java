...
public class MoreappsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        ImageView imageXtereo = binding.imageXtereo;
        imageXtereo.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.LionRigStudio.XtereO"));
            startActivity(browserIntent);
        });

        TextView xtereoLink = binding.xtereo;
        xtereoLink.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.LionRigStudio.XtereO"));
            startActivity(browserIntent);
        });
        ImageView imageMinescope = binding.imageMinescope;
        imageMinescope.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.universitat_autonoma_de_barcelona_geology_mineralogy.minescope"));
            startActivity(browserIntent);
        });
        TextView minescopeLink = binding.minescope;
        minescopeLink.setOnClickListener(v -> {
            Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.universitat_autonoma_de_barcelona_geology_mineralogy.minescope"));
            startActivity(browserIntent);
        });
        return root;
